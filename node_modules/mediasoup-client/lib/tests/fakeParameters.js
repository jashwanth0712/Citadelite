...
exports.generateDataConsumerRemoteParameters = exports.generateDataProducerRemoteParameters = exports.generateConsumerRemoteParameters = exports.generateProducerRemoteParameters = exports.generateTransportRemoteParameters = exports.generateLocalDtlsParameters = exports.generateNativeSctpCapabilities = exports.generateNativeRtpCapabilities = exports.generateRouterRtpCapabilities = void 0;
...
function generateConsumerRemoteParameters({ id, codecMimeType } = {}) {
    switch (codecMimeType) {
        case 'audio/opus':
            {
                return {
                    id: id || (0, v4_1.default)(),
                    producerId: (0, v4_1.default)(),
                    kind: 'audio',
                    rtpParameters: {
                        codecs: [
                            {
